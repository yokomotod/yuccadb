...
func download(ctx context.Context, localFile, gcsPath string) error {
	...
	file, err := os.OpenFile(localFile, os.O_RDWR|os.O_CREATE|os.O_EXCL, dataFilePermission)
	if err != nil {
...
func cp(localFile, srcPath string) error {
	...
	// use OpenFile with os.O_EXCL instead of Create to avoid overwriting
	dst, err := os.OpenFile(localFile, os.O_RDWR|os.O_CREATE|os.O_EXCL, dataFilePermission)
	if err != nil {
